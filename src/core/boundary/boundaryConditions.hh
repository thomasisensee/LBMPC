...
BoundaryCondition<T,DESCRIPTOR>::BoundaryCondition(BoundaryLocation loc) : _location(loc) {}

template<typename T,typename DESCRIPTOR>
BoundaryLocation BoundaryCondition<T,DESCRIPTOR>::getLocation() const {
    return _location;
}

template<typename T,typename DESCRIPTOR>
void BoundaryCondition<T,DESCRIPTOR>::prepareKernelParams(const BaseParams& baseParams) {
...
template<typename T,typename DESCRIPTOR>
void BoundaryCondition<T,DESCRIPTOR>::printBoundaryLocation() const {
    std::cout << "== Boundary Location: " << boundaryLocationToString(_location) << "\t==" << std::endl;
}

template<typename T,typename DESCRIPTOR>
void BoundaryCondition<T,DESCRIPTOR>::printParameters() const {
...
/**************************************/
template<typename T,typename DESCRIPTOR>
Periodic<T,DESCRIPTOR>::Periodic(BoundaryLocation loc) : BoundaryCondition<T,DESCRIPTOR>(loc) {}
...
void Periodic<T,DESCRIPTOR>::printParameters() const {
    BoundaryCondition<T,DESCRIPTOR>::printBoundaryLocation();
...
/*****************************************/
template<typename T,typename DESCRIPTOR>
BounceBack<T,DESCRIPTOR>::BounceBack(BoundaryLocation loc) : BoundaryCondition<T,DESCRIPTOR>(loc) {}
...
void MovingWall<T,DESCRIPTOR>::prepareKernelParams(const BaseParams& baseParams) {
    BoundaryCondition<T,DESCRIPTOR>::prepareKernelParams(baseParams);
...
/**********************************************/
template<typename T,typename DESCRIPTOR>
AntiBounceBack<T,DESCRIPTOR>::AntiBounceBack(BoundaryLocation loc, T wallValue) : BounceBack<T,DESCRIPTOR>(loc), _wallValue(wallValue) {}
...
template<typename T,typename DESCRIPTOR>
void BoundaryConditionManager<T,DESCRIPTOR>::addBoundaryCondition(std::unique_ptr<BoundaryCondition<T,DESCRIPTOR>> condition) {
